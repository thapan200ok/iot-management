using iot_management.Application.Common.Models;
using iot_management.Application.TodoItems.Commands.CreateTodoItem;
using iot_management.Application.TodoItems.Commands.DeleteTodoItem;
using iot_management.Application.TodoItems.Commands.UpdateTodoItem;
using iot_management.Application.TodoItems.Commands.UpdateTodoItemDetail;
using iot_management.Application.TodoItems.Queries.GetTodoItemsWithPagination;
